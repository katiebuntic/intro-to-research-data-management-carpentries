...
- each draw is a an aspect of the project e.g. drawer 1 for data collection; drawer 2 for analysis; drawer 3 for papers and presentations
...
Within each folder in each drawer there may be further sub-sections.... However, do be sensible about the level and number of folders you use: if you have lots of folders that only contain one file, you may have too many, making it more difficult and time-consuming to navigate. If you have very few folders then there may be too many files in a folder, making it difficult to find the relevant one.
